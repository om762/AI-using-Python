...
# Transitional Model
model.add_edge(market_up, market_up, 0.8)  # If today's market is up then probability of tommorow market will up
model.add_edge(market_up, market_down, 0.2) # If today's market is up then probability of tommorow will be go down
model.add_edge(market_down, market_down, 0.5) # If today is market is down then probability of tommorow will be market go down too
model.add_edge(market_down, market_up, 0.5) # If today is market is down then probability of tommorow will not go down i.e. it will go up
